/*
 * This scanner file was taken from Carmen written by Timothy Carpenter
 * due to possible errors in the scanner file that I wrote.
 */
                ...
                switch ((char) character) {
                    ...
                    default: {
                        ...
                        if (Character.isDigit((char) character)) {
                            while (continued) {
                                this.token.append((char) character);
                                this.in.mark(1);
                                character = this.in.read();
                                continued = character != -1
